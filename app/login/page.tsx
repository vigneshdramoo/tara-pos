...
export default async function LoginPage({ searchParams }: LoginPageProps) {
  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden px-4 py-10 sm:px-6">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,_rgba(215,174,104,0.18),_transparent_42%),linear-gradient(180deg,_#f8f2ea_0%,_#f4ede4_46%,_#efe6db_100%)]" />
      <div className="absolute inset-x-0 top-0 h-60 bg-[linear-gradient(180deg,rgba(143,90,71,0.10),transparent)]" />

      <section className="relative z-10 grid w-full max-w-5xl gap-8 rounded-[36px] border border-white/70 bg-white/55 p-6 shadow-[0_40px_120px_rgba(34,25,18,0.12)] backdrop-blur md:grid-cols-[minmax(0,1.2fr)_420px] md:p-8">
        <div className="flex flex-col justify-between rounded-[30px] bg-stone-950 px-6 py-8 text-stone-50 md:px-8">
          <div>
            <p className="text-xs uppercase tracking-[0.42em] text-stone-300">TARA</p>
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-3">
            <div className="rounded-[22px] border border-white/10 bg-white/6 p-4">
              <p className="text-xs uppercase tracking-[0.24em] text-stone-400">Reach</p>
            ...
            <div className="rounded-[22px] border border-white/10 bg-white/6 p-4">
              <p className="text-xs uppercase tracking-[0.24em] text-stone-400">Protection</p>
        ...
        <div className="flex items-center">
          <div className="w-full">
            <p className="text-xs uppercase tracking-[0.34em] text-stone-500">Private Entry</p>
            <h2 className="mt-3 font-display text-4xl text-stone-950">Enter the selling floor</h2>
