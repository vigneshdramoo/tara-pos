...
export const catalogProductSeeds: CatalogProductSeed[] = [
  ...
  {
    slug: "theon",
    sku: "TARA-SIG-50-THEON",
    name: "THEON",
    collection: "Signature",
    description:
      "THEON is a warm, creamy tea fragrance where golden oolong and osmanthus are steeped in coconut cream, soft vanilla, sandalwood, and skin-close musk. It turns a small daily ritual into something luminous.",
    notes: "Bergamot, Golden Oolong, Osmanthus, Green Tea, Coconut Cream, Soft Vanilla, Sandalwood, Warm Musk",
  ...
  {
    slug: "theon-10ml",
    sku: "TARA-SIG-8-THEON",
    name: "THEON 8mL",
    collection: "Signature",
    description:
      "A travel-size THEON for discovery, gifting, and quiet daily rituals. Golden oolong and osmanthus soften into coconut cream, vanilla, sandalwood, and skin-close musk.",
    notes: "Bergamot, Golden Oolong, Osmanthus, Green Tea, Coconut Cream, Soft Vanilla, Sandalwood, Warm Musk",
    mood: "Warm, Calm, Luminous",
    sizeMl: 8,
    priceCents: 4500,
